...
<div class="container">
  ...
  <div class="col-sm-3 sidenav">
        ...
        <li>Lihat Data</li>
        <li class="active"><a href="../list/list_ktp.php">Lihat KTP</a></li>
...
include ('../../config.php');
	...
	$data = "select * from ktp right join nktp on ktp.nik=nktp.nik";
  ...
  $hapus="<a href='../hapus/hapus_ktp.php?nik=$nik'>Hapus</a>";
  ...
  <TD>".$nama_ayah."</TD><TD>".$nama_ibu."</TD><TD>".$pendidikan."</TD><TD>".$hapus."</TD><TR>";
